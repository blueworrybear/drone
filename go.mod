...
replace github.com/drone/drone-ui v0.0.0-20191004020100-87de5a7c28a9 => ../drone-ui

replace github.com/drone/drone-runtime v1.1.0 => github.com/blueworrybear/drone-runtime v1.2.0
